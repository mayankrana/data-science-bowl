...
cmd:option('-results_path',    'results/exp_1_5',   'subdirectory to save/log experiments in')
...
dofile('1_data_1_5.lua')
if not opt.dataTest then
   dofile('2_model_1_5.lua')
   dofile('3_train_1_5.lua')
   dofile('4_test_1_5.lua')
